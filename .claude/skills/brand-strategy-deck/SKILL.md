...
template.html의 CSS 변수를 그대로 쓴다. 프로젝트마다 `--accent1`·`--accent2`만 교체:

```css
:root{
  --cream:#F7F3EA; --paper:#FBF8F1;           /* 배경·카드 — 고정 */
  --ink:#2E2A22; --ink2:#5E574A; --ink3:#938A78;  /* 잉크 3단 — 고정 */
  --accent1:#7E9A6E; --accent2:#DD9B45;       /* ← 프로젝트마다 이 2색만 교체 */
  --line:#E7E0D2;
}
```

**새 프로젝트마다 HTML을 처음부터 다시 디자인하지 않는다.**
